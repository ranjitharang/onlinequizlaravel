...
<head>
  ...
  <link href="{{ asset('AdminLTE/https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i') }}" rel="stylesheet">

 <!--Custom styles for answer template-->
 <link href="{{ asset('AdminLTE/css/sb-admin-2.css') }}" rel="stylesheet" type="text/css">
 <link href="{{ asset('AdminLTE/css/sb-admin-2.min.css') }}" rel="stylesheet" type="text/css">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    color: rgb(194, 225, 241)">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('/answers')}}" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-color.html">Maths</a>
            <a class="collapse-item" href="utilities-border.html">History</a>
            <a class="collapse-item" href="utilities-animation.html">Science</a>
            <a class="collapse-item" href="utilities-animation.html">General Knowledge</a>
            <a class="collapse-item" href="utilities-other.html">Computers</a>
          </div>
        </div>
      </li>
      ...
      <!-- Heading -->
      <div class="sidebar-heading" style="color:rgb(194, 225, 241)">
        Addons
      </div>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Ranjitha Rangan</span>
                <img class="img-profile rounded-circle" src="{{ asset('AdminLTE/img/ranjitha.jpg')}}">
              </a>
