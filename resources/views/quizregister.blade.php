...
<!-- Custom styles for login template-->
 <link href="{{ asset('AdminLTE/css/register.css') }}" rel="stylesheet" type="text/css">
...
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <h3>Welcome.</h3>
                        <input type="button" onclick="window.location.href = 'http://localhost:8000/quizlogin';" name="" value="Login"/><br/>
                    </div>
